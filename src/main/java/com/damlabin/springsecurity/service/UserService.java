package com.damlabin.springsecurity.service;

import com.damlabin.springsecurity.domain.*;
import com.damlabin.springsecurity.exception.*;
import com.damlabin.springsecurity.mapper.UserMapper;
import com.damlabin.springsecurity.repository.*;
import com.damlabin.springsecurity.security.AuthoritiesConstants;
import com.damlabin.springsecurity.service.dto.UserDTO;
import com.damlabin.springsecurity.utils.*;
...
public class UserService {
    ...
    public Page<UserDTO> getAllManagedUsers(Pageable pageable) {
        return userRepository.findAllByLoginNot(pageable, ConstantsUtils.ANONYMOUS_USER).map(UserDTO::new);
    }
    ...
    public User getCurrentUser() {
        ...
        User user = getUserWithAuthoritiesByLogin(login).get();
        return user;
    }
}
